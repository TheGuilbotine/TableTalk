...
# 2 { name: "Canyon City BBQ", phone_number: "(626) 815-4227", address_id: 2, business_id: "1", description: "Our restaurant sits at the foothills of the San Gabriel Mountains.  We have been told that our restaurant looks and feels like the ones down south.  Whether it’s the tri-tip, brisket, ribs, burnt ends, or pulled pork sandwiches, the meat is cooked to perfection, and the baked beans, coleslaw, or potato salad make perfectly delicious side dishes.", price_range: "2", cuisine_id: "2", created_at: new Date(), updated_at: new Date() },
# 3 { name: "President Thai", phone_number: "(626) 578-9814", address_id: 3, business_id: "1", description: "Established in 1994, President Thai’s mission is to offer to the community, the authenticity in Thai food, culture, and atmosphere. Rebuilt to become the first traditional Thai style architecture restaurant in Los Angeles with the interior finely decorated with ornate Thai art form, and soothed with traditional music. Customers will find themselves being taken back in time to experience the traditional ways of Thai’s culture. We are ready to greet you in Thai, Sawadee ka!", price_range: "2", cuisine_id: "4", created_at: new Date(), updated_at: new Date() }

# Sunny
# 4 { name: "name", phone_number: "number", address_id: 4, business_id: "#", description: "text", price_range: "1-5", cuisine_id: "#", created_at: new Date(), updated_at: new Date() },
# 5 { name: "name", phone_number: "number", address_id: 5, business_id: "#", description: "text", price_range: "1-5", cuisine_id: "#", created_at: new Date(), updated_at: new Date() },
# 6 { name: "name", phone_number: "number", address_id: 6, business_id: "#", description: "text", price_range: "1-5", cuisine_id: "#", created_at: new Date(), updated_at: new Date() }

# Pierre
# TODO Add cuisine type ids.
# 7 { name: "The Meatball Shop", phone_number: "(212) 230-5860", address_id: 7, business_id: 3, description: "Buzzy outfit serving a range house-ground meatballs, sauces & sides plus ice cream sandwiches.", price_range: 2, cuisine_id: "#", created_at: new Date(), updated_at: new Date() },
# 8 { name: "Sweet Potatoes", phone_number: "(336) 727-4844", address_id: 8, business_id: 3, description: "Chicken & waffles, mac 'n' cheese & banana pudding round out the menu at this soul-food staple.", price_range: 2, cuisine_id: "#", created_at: new Date(), updated_at: new Date() },
# 9 { name: "The Old Fourth Street Filling Station", phone_number: "(336) 724-7600", address_id: 9, business_id: 3, description: "Trendy upscale New American eatery & bar with a fireplace & covered outdoor terrace.", price_range: 2, cuisine_id: "#", created_at: new Date(), updated_at: new Date() }

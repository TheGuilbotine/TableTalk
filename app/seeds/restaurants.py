...
def seed_restaurants():
    ...
    restaurant2 = Restaurant(
        name="Canyon City BBQ", phone_number="(626) 815-4227", address_id=2, business_id=1, description="Our restaurant sits at the foothills of the San Gabriel Mountains.  We have been told that our restaurant looks and feels like the ones down south.  Whether it’s the tri-tip, brisket, ribs, burnt ends, or pulled pork sandwiches, the meat is cooked to perfection, and the baked beans, coleslaw, or potato salad make perfectly delicious side dishes.", price_range=2, cuisine_id=2)
    restaurant3 = Restaurant(
        name="President Thai", phone_number="(626) 578-9814", address_id=3, business_id=1, description="Established in 1994, President Thai’s mission is to offer to the community, the authenticity in Thai food, culture, and atmosphere. Rebuilt to become the first traditional Thai style architecture restaurant in Los Angeles with the interior finely decorated with ornate Thai art form, and soothed with traditional music. Customers will find themselves being taken back in time to experience the traditional ways of Thai’s culture. We are ready to greet you in Thai, Sawadee ka!", price_range=2, cuisine_id=4)
    restaurant4 = Restaurant(
        name="The Park Cafe", phone_number="(801) 487-1670", address_id=4, business_id=2, description="Buzzy cafe serving up homestyle breakfasts, burgers & salads in a cozy setting with park views.", price_range=1, cuisine_id=9)
    restaurant5 = Restaurant(
        name="My Thai", phone_number="(801) 505-4999", address_id=5, business_id=2, description="Snug, no-frills cafe known for Thai classics like curries & spring rolls, with budget lunch combos.", price_range=1, cuisine_id=4)
    restaurant6 = Restaurant(
        name="Saffron Valley", phone_number="(801) 203-3325", address_id=6, business_id=2, description="2-story contemporary outpost features classic Indian fare with a modern spin & a daily lunch buffet.", price_range=2, cuisine_id=11)
